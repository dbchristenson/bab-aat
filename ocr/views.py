...
def document_detail(request, document_id):
    ...
    logger.info(f"page_detection: {page_detections}")
    logger.info(f"bool(page_detections): {bool(page_detections)}")
    logger.info(f"len(page_detections): {len(page_detections)}")
